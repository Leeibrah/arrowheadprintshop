                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <ul class="icon-list">
                                        ...
                                        <li>
                                            PAYE & employment taxes Risk and governance assurance
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            Tax investigations, audits and dispute advisory
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="project-thumbnail">
                                        <img src="/images/services/tax.png" class="img-responsive" alt="post-img">
                                    </div>
                                </div>
                            </div>
