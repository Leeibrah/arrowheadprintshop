                ...
                <div class="col-md-9">
                    ...
                    <article class="project project-single hv-wrapper">
                        ...
                        <div class="post-content clearfix">
                            ...
                            <h6>Accounting Services we offer:</h6>
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <ul class="icon-list">
                                        ...
                                        <li>
                                             Extracte trial balance & preparation of statements
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            Preparation and submission of VAT, NSSF, NHIF, NITA.
                                        </li>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="project-thumbnail">
                                        <img src="/images/services/accounting.png" class="img-responsive" alt="post-img">
                                    </div>
                                </div>
                            </div>
