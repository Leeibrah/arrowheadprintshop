        ...
        <div class="auto-container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <p>
                        Contact Information such as name, email address, mailing address, phone number, Unique Identifiers such as user name, date of birth, password
                    </p>
                    ...
                    <p>
                        Demographic information such as age, education, gender, interests and postal code <br/>
                        As is true of most Web sites, we automatically gather information about your computer such as IP address, browser type, referring/exit pages, and operating system. <br/>
                    </p>

                    <p>
                        To verify any of the information that you provide in order to effect, administer and fulfil your transactions. <br/>
                        Send you an order confirmation. <br/>
                        Send you requested product or service information. <br/>
                        Send you marketing information or correspond re complaint. <br/>
                        To comply with legal obligations including those aimed at preventing breach of money laundering regulations <br/>
                        If you provide us personal information about others, or if others give us your information, we will only use that information for the specific reason for which it was provided to us. <br/>
                    </p>
                    ...
                    <p>
                        In order to comply with legal, regulatory, security and processing requirements, government requirements applicable to us, our Affiliates or service providers, including but not limited to anti-money laundering laws;
                    </p>

                    <p>
                        When we believe in good faith that disclosure is necessary to protect your safety or the safety of others, investigate fraud, or respond to a government request/requirements <br/>
                        As permitted or required by the relevant law <br/>
                    ...
                    <p>
                        We may use cookies, for example, to keep track of your preferences and profile information. Cookies are also used to collect general usage and volume statistical information that those not include personal information.
                    </p>

                    <p>
                        Our Web pages contain electronic images known as Web beacons and are used along with cookies to compile aggregated statistics to analyse how our site is used and may be used in some of our emails to let us know which emails and links have been opened by recipients. This allows us to gauge the effectiveness of our customer communications and marketing campaigns. We use a third party to gather information about how you and others use our Web site. For example, we will know how many users access a specific page and which links they clicked on. We use this aggregated information to understand and optimize how the site is used.
                    </p>
                    ...
                    <p>
                        Our Web site includes widgets, which are interactive mini-programs that run on our site to provide specific services from another company (e.g. displaying the news, opinions, etc.). Personal information, such as your email address, may be collected through the Widget. Cookies may also be set by the Widget to enable it to function properly. Information collected by this Widget is governed by the privacy policy of the company that created it.
                    </p>
                    ...
                    <p>
                        If we make changes to any of our privacy policies or practices with respect to how we use personally identifiable information, we’ll post those changes to this privacy statement as and when they come into effect. We encourage you to periodically review this page for the latest information on our privacy practices.
                    </p>
